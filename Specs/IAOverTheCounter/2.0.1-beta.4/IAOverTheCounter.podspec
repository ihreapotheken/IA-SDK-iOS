Pod::Spec.new do |s|
  ...
  s.source           = { :http => 'https://github.com/ihreapotheken/IA-SDK-iOS/releases/download/2.0.1-beta.4/IAOverTheCounter-2.0.1-beta.4.xcframework.zip' }
  s.ios.deployment_target = '15.0'
  s.vendored_frameworks = ['IAOverTheCounter.xcframework']
  s.dependency 'IACore', '2.0.1-beta.4'
end
