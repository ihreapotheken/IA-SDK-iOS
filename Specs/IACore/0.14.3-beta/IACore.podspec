Pod::Spec.new do |s|
  ...
  s.source           = { :http => 'https://github.com/ihreapotheken/IA-SDK-iOS/releases/download/0.14.3-beta/IACore-0.14.3-beta.xcframework.zip' }
  s.ios.deployment_target = '15.0'
  s.vendored_frameworks = ['IACore.xcframework']
  s.dependency 'IOSKit', '0.14.3-beta'
end